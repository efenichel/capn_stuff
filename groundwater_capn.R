...
ksdata <-readRDS(gzcon(url("https://github.com/efenichel/capn_stuff/raw/forspi/KSwater_data.RDS"))) #RDS upload
...
source("https://github.com/efenichel/capn_stuff/raw/forspi/data_setup.R")
}
